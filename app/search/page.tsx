      ...
      <div className="px-4 mb-4 flex items-center gap-3">
        <form onSubmit={onSubmit} className="relative flex-1">
          <input
            ...
            placeholder="Mencari"
            autoFocus
            className="w-full bg-[#2A2A2A] text-white rounded-full py-2.5 px-4 focus:outline-none focus:ring-1 focus:ring-[#FA243C]/50 transition-all border border-white/5"
          />
          {query && (
            <button 
              type="button"
